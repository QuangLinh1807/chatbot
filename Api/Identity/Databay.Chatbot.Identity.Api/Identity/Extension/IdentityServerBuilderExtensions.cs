...
using Databay.Chatbot.Identity.Api.Identity.Store;
...
namespace Databay.Chatbot.Identity.Api.Identity.Extension
{
    public static class IdentityServerBuilderExtensions
    {
        ...
        public static IIdentityServerBuilder AddMongoDbForAspIdentity<TIdentity, TRole>(this IIdentityServerBuilder builder, IConfigurationRoot configurationRoot) where
            TIdentity : ApplicationUser where TRole : IdentityRole
        {
		...
		public static IIdentityServerBuilder Add(this IIdentityServerBuilder builder)
		{
			builder.Services.AddTransient<IResourceStore, CustomResourceStore>();
			return builder;
		}
